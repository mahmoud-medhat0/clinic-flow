...
const styles = StyleSheet.create({
  ...
  rtlHeader: {
    // In current header design (centered vertical stack), RTL doesn't change much unless we change to row
    // But keeping this if we switch to row later or for strict alignment
  },
  iconContainer: {
    width: 56,
    height: 56,
